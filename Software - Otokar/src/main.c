 ...
 * 1.1        Erdem Tayfun Salman       04/01/2016       OTOKAR araclar icin 1 nolu kapi voltaj seviyesine gore gerekli degisiklik yapildi
 ******************************************************************************/
...
main(void)
{
    ...
    while(1)
    {
        ...
        if(uartState == SM_SEND_DATA)
        {
            ...
            setTimeOut(150);
//            if(bit_test(doorStates,0)) //Bu bolum KARSAN araclar icin kullanilir
//            {
//                putch('1');
//            }
//            else
...
//                putch('0');
//            }
            if(bit_test(doorStates,0)) //Bu bolum OTOKAR araclar icin kullanilir
            {
                putch('0');
            }
            else
